    ...
    <>
      ...
      >
          ...
          <div className="grid lg:grid-cols-2 gap-4 lg:gap-10 items-center">
            <div className="order-2 lg:order-1 px-4 sm:px-6 lg:pl-[max(2rem,calc((100vw-80rem)/2+2rem))] lg:pr-0 text-center lg:text-left">
              ...
              <div className="grid grid-cols-3 lg:grid-cols-3 gap-2 lg:gap-5 my-4 max-w-2xl mx-auto lg:mx-0">
                {[
                  { icon: Wallet, title: "No hidden fees", desc: "Clear pricing." },
                  { icon: Truck, title: "Free delivery", desc: "Anywhere in Bali." },
                  { icon: Clock, title: "24/7 support", desc: "Always on call." },
            ...
            <div className="order-1 lg:order-2 relative w-full">
              <div className="relative w-full h-[200px] sm:h-[300px] lg:h-[460px] xl:h-[500px]">
                <img
                  src="/images/hero.png"
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 pb-12">
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {[
                { icon: CheckCircle, title: "Free cancellation", desc: "Up to 24h" },
                { icon: Gauge, title: "Unlimited mileage", desc: "Drive freely" },
                { icon: Shield, title: "Full insurance", desc: "Fully covered" },
                { icon: Clock, title: "Flexible rentals", desc: "Day. Week. Month." },
              ].map(({ icon: Icon, title, desc }) => (
        ...
        <section id="deals" className="pt-6 pb-8 lg:pt-8 lg:pb-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-5">
              <div>
                <h2 className="font-bold tracking-tight" style={{ color: "#0a0a0a", margin: 0, fontSize: "clamp(1.5rem, 1rem + 1vw, 1.75rem)", letterSpacing: "-0.02em", fontWeight: 700 }}>Special offers</h2>
              </div>
        ...
        <section id="vehicles" className="pt-6 pb-8 lg:pt-8 lg:pb-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 lg:p-6 grid grid-cols-2 lg:grid-cols-4 gap-y-5">
              {[
                { icon: CheckCircle, title: "Well-maintained", desc: "Clean & safe" },
                { icon: Tag, title: "Honest pricing", desc: "No surprises" },
                { icon: MapPin, title: "Island-wide", desc: "Wherever you go" },
                { icon: Users, title: "Trusted", desc: "10,000+ travelers" },
        ...
        <section id="destinations" className="pt-6 pb-8 lg:pt-8 lg:pb-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-5">
              <h2 className="font-bold tracking-tight" style={{ color: "#0a0a0a", margin: 0, fontSize: "clamp(1.5rem, 1rem + 1vw, 1.75rem)", letterSpacing: "-0.02em", fontWeight: 700 }}>Top destinations</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-5">
              {[
                { name: "Ubud", desc: "Rice terraces & culture", img: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=600&q=80" },
                { name: "Seminyak", desc: "Beach clubs & nightlife", img: "https://images.unsplash.com/photo-1555400038-63f5ba517a47?auto=format&fit=crop&w=600&q=80" },
                { name: "Uluwatu", desc: "Cliffs & sunsets", img: "https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=600&q=80" },
                { name: "Nusa Penida", desc: "Crystal waters", img: "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&w=600&q=80" },
                { name: "Canggu", desc: "Surf & cafés", img: "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&w=600&q=80" },
              ].map((dest) => (
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
                {[
                  { text: "Super easy booking and the car was in perfect condition. Delivery to our villa was seamless!", name: "Jason R.", country: "Australia", img: "https://i.pravatar.cc/100?img=11" },
                  { text: "Best car rental experience in Bali. No hidden fees and great customer service.", name: "Sarah M.", country: "Singapore", img: "https://i.pravatar.cc/100?img=5" },
                  { text: "The car was clean and fuel-efficient and perfect for our trip around the island.", name: "David L.", country: "United States", img: "https://i.pravatar.cc/100?img=12" },
                  { text: "Highly recommend! They even helped us with local tips and route suggestions.", name: "Mila K.", country: "Indonesia", img: "https://i.pravatar.cc/100?img=9" },
                ].map((review) => (
