          ...
          >
            ...
            <div className="mt-3 flex justify-end">
              <button
                ...
                className="px-3 py-1.5 text-xs font-bold text-white rounded-md transition-colors"
                style={{ backgroundColor: "#1d4046" }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#173238")}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#1d4046")}
              >
                Done
              </button>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-12 lg:h-14">
              ...
              <div className="flex items-center gap-3 lg:gap-5">
                ...
                <a
                  href="#book"
                  className="hidden sm:inline-flex items-center px-5 py-2.5 text-white text-[13px] font-semibold rounded-lg transition-colors"
          ...
          {mobileOpen && (
            <div className="lg:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-3">
              ...
              <div className="pt-3 border-t border-gray-100 flex flex-col gap-3">
                ...
                <a href="#book" className="inline-flex items-center justify-center px-5 py-2.5 text-white text-sm font-semibold rounded-lg" style={{ backgroundColor: TEAL }}>
                  Book now
                </a>
              </div>
            </div>
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 pb-12">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[repeat(4,minmax(0,1fr))_auto] gap-4 lg:gap-3 items-end">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 h-[46px] px-5 text-white text-sm font-bold rounded-lg transition-colors w-full lg:w-auto sm:col-span-2 lg:col-span-1"
                style={{ backgroundColor: TEAL }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = TEAL_DARK)}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = TEAL)}
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-[26.5fr_15fr_15fr_17fr_26.5fr] gap-8 lg:gap-6 pb-10 mb-6 border-b border-gray-100">
              ...
              <div className="col-span-2 md:col-span-3 lg:col-span-1">
                ...
                <p className="text-xs text-gray-500 mb-3 leading-relaxed">Deals and Bali stories, in your inbox.</p>
                <input
                  type="email"
