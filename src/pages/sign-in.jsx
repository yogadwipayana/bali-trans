  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          // Same light-mode override the home page uses so the global
          // prefers-color-scheme dark variables don't bleed in.
          "--text": "#6b7280",
          "--text-h": "#1a1a1a",
          "--bg": "#ffffff",
          "--border": "#e5e7eb",
          ...
          <div className="grid lg:grid-cols-2 min-h-[640px] lg:min-h-[760px]">
            ...
            <aside className="relative hidden lg:block overflow-hidden">
              <img
                ...
                loading="eager"
              />
              {/* Dark gradient so the white text below stays readable. */}
              <div
              ...
              />
              {/* Soft right-edge fade so the panel blends into the white form side. */}
              <div
              ...
              <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_8px_32px_rgba(0,0,0,0.06)] p-6 sm:p-8 lg:p-10">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed mb-6">
                    Sign in to your account and continue your journey with Bali Trans.
                  </p>
